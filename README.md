...
`
python -m caffe2onnx.convert --prototxt googlenet.prototxt --caffemodel googlenet.caffemodel --onnx googlenet.onnx --frozen true
`

Or you can use simply version of command  
`
